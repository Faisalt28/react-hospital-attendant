      ...
      <form onSubmit={handleSave} className="space-y-6">
        ...
        <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 shadow-sm overflow-hidden">
          ...
          <div className="p-4 sm:p-6 space-y-5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3.5 py-2 text-sm rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-emerald-400"
                  required
                />
              </div>
            ...
            {/* Geofence Map Picker (Desktop Sejajar, Mobile Vertikal ke Bawah) */}
            <div className="pt-1">
              <GeofenceMapPicker
                ...
                onHospitalNameChange={(name) => handleChange("hospitalName", name)}
